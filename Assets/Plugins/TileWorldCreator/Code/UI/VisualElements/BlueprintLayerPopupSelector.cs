    ...
    public class BlueprintLayerPopupSelector : PopupWindowContent
    {
        ...
        void RefreshScrollView()
        {
            ...
            foreach (var _layer in _layers)
            {
                ...
                _item.style.backgroundColor = TileWorldCreatorColor.Grey.GetColor();
                ...
                _item.RegisterCallback<MouseEnterEvent>(evt => _item.style.backgroundColor = TileWorldCreatorColor.LightGrey.GetColor());
                _item.RegisterCallback<MouseLeaveEvent>(evt => _item.style.backgroundColor = TileWorldCreatorColor.Grey.GetColor());
