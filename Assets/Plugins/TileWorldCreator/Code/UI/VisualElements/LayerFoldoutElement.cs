...
namespace GiantGrey.TileWorldCreator.UI
{
    public class LayerFoldoutElement : VisualElement
    {
        ...
        params Action[] _additionalButtons)
        {
            ...
            var _dragManipulator =  new VisualElement();
            ...
            _dragIcon.style.backgroundImage = TileWorldCreatorUtilities.LoadImage("moveToFolder.twc");
            _dragIcon.style.width = 24;
            _dragIcon.style.height = 24;

            _dragManipulator.Add(_dragIcon);
            ...
            container.style.backgroundColor = contentBGColor;
