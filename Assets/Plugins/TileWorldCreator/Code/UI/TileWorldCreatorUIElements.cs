...
namespace GiantGrey.TileWorldCreator.UI
{
    ...
    {
       public static Button FlatButton(string _title, Texture2D _icon, int _iconWidth, int _iconHeight)
       {
        	var _b = new Button();
			_b.text = _title;
            ...
            _b.style.backgroundColor = TileWorldCreatorColor.Grey.GetColor();
            ...
            _b.RegisterCallback<MouseEnterEvent>(e => _b.style.backgroundColor = TileWorldCreatorColor.LightGrey.GetColor());
            _b.RegisterCallback<MouseLeaveEvent>(e => _b.style.backgroundColor = TileWorldCreatorColor.Grey.GetColor());
       ...
       {
            _button.style.backgroundColor = _active ? TileWorldCreatorColor.PaleBlue.GetColor() : TileWorldCreatorColor.Grey.GetColor();
       }
       ...
       public static VisualElement Separator(string _title = "")
       {
            ...
            _sep.style.backgroundColor = Color.black;
