...
namespace GiantGrey.TileWorldCreator
{
    ...
    public class TilePresetEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            _header.style.backgroundColor = colDarkGrey;
            ...
            _materialOverride.style.backgroundColor = colDarkGrey;
            ...
            _thumbnailContainer.style.backgroundColor = colDarkGrey;
            ...
            _setThumbnail.label = "";
            _setThumbnail.style.maxWidth = 100;
